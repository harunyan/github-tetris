...
export default function Tetris(){
  ...
  function draw(){
    ...
    // ghost
    const gY = ghostPos()
    drawMatrix(ctx, pieceRef.current.matrix, posRef.current.x, gY, 'rgba(255,255,255,0.08)')

    // active piece
    drawMatrix(ctx, pieceRef.current.matrix, posRef.current.x, posRef.current.y, pieceRef.current.color)
  }
